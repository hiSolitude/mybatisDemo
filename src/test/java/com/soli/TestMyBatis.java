...
public class TestMyBatis {
    ...
    public void testQueryUser(){
        ...
        try {
            User user = (User) session.selectOne("com.soli.UserMapper.selectByID" ,1);
    ...
    public void testInsertUser(){
        ...
        try {
            ...
            //返回值是记录条数
            int resultCount = session.insert("com.soli.UserMapper.add", user );
            session.commit() ;
    ...
    public void testUpdateUser(){
        ...
        try {
            ...
            //返回值是修改条数
            int updateCount = session.update("com.soli.UserMapper.update", user );
            session.commit() ;
    ...
    public void testDelete(){
        ...
        try {
            //返回值是删除条数
            int deleteCount = session.update("com.soli.UserMapper.deleteById", 4 );
            session.commit() ;
